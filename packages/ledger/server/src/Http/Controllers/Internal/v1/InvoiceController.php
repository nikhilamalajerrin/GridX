...
use GridX\Ledger\Models\InvoiceItem;
...
class InvoiceController extends LedgerResourceController
{
    ...
    public function createFromOrder(Request $request): InvoiceResource
    {
        ...
        $order = \GridX\FleetOps\Models\Order::where('company_uuid', session('company'))
     ...
     * not affected.
     */
    private function normaliseTemplateContextType(\GridX\Models\Template $template): \GridX\Models\Template
    {
