...
namespace GridX\Ledger\Models;

use GridX\Models\Transaction as BaseTransaction;
...
class Transaction extends BaseTransaction
{
    ...
    {
        return $this->hasMany(\GridX\Models\TransactionItem::class, 'transaction_uuid', 'uuid');
    }
