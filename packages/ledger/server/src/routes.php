...
| and are protected by the 'gridx.protected' middleware which requires a
| valid GridX session or API key.
|
*/
Route::prefix(config('ledger.api.routing.prefix', 'ledger'))->namespace('GridX\Ledger\Http\Controllers')->group(
    function ($router) {
        /*
        |--------------------------------------------------------------------------
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | Internal Routes (Authenticated via GridX Session — Console)
        |--------------------------------------------------------------------------
        */
                    ...
                    function ($router) {
                        $router->group(
                            ...
                            function ($router) {
                                ...
                                // Payment Gateways
                                // ----------------------------------------------------------------
                                // The 'drivers' static route must be registered BEFORE gridxRoutes
