...
namespace GridX\Ledger\Seeders;
 ...
 * LedgerSeeder
 *
 * Seeds the default system chart of accounts for every company in the GridX
 ...
 *
 * Usage:
 *   php artisan db:seed --class="GridX\Ledger\Seeds\LedgerSeeder"
 *
...
class LedgerSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $companyModel = app('GridX\Models\Company');
