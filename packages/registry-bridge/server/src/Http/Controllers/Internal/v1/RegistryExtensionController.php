...
use GridX\RegistryBridge\Http\Controllers\RegistryBridgeController;
use GridX\RegistryBridge\Http\Requests\CreateRegistryExtensionRequest;
use GridX\RegistryBridge\Http\Requests\RegistryExtensionActionRequest;
use GridX\RegistryBridge\Http\Resources\PublicRegistryExtension;
...
class RegistryExtensionController extends RegistryBridgeController
{
    ...
    {
        $currentRegistryHost     = config('registry-bridge.registry.host', env('REGISTRY_HOST', 'https://registry.gridx.io'));
