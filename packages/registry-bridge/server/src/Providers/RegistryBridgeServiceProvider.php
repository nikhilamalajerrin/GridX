...
namespace GridX\RegistryBridge\Providers;

use GridX\Models\Setting;
use GridX\Providers\CoreServiceProvider;

if (!class_exists(CoreServiceProvider::class)) {
    throw new \Exception('Registry Bridge cannot be loaded without `gridx/core-api` installed!');
}
...
class RegistryBridgeServiceProvider extends CoreServiceProvider
{
     ...
     */
    public $commands = [
        \GridX\RegistryBridge\Console\Commands\Initialize::class,
    ];
