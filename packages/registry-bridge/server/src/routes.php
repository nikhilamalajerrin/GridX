...
Route::get(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/extensions', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryExtensionController@listPublicExtensions');
Route::get(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/lookup', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryController@lookupPackage');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/bundle-upload', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryController@bundleUpload');

// Developer account registration (public, no auth required)
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/register', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@register');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/verify', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@verifyEmail');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/resend-verification', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@resendVerification');
Route::post(config('registry-bridge.api.routing.prefix', '~registry') . '/v1/developer-account/generate-token', 'GridX\RegistryBridge\Http\Controllers\Internal\v1\RegistryDeveloperAccountController@generateToken');
Route::prefix(config('registry-bridge.api.routing.prefix', '~registry'))->middleware(['gridx.registry'])->namespace('GridX\RegistryBridge\Http\Controllers')->group(
    function ($router) {
        /*
         * Internal Routes v1
         */
        $router->group(['prefix' => config('registry-bridge.api.routing.internal_prefix', 'v1'), 'namespace' => 'Internal\v1'], function ($router) {
            $router->group(['prefix' => 'auth'], function ($router) {
                $router->group(['middleware' => ['gridx.protected']], function ($router) {
            ...
            $router->group(['middleware' => ['gridx.protected']], function ($router) {
                ...
                $router->gridxRoutes('registry-extensions', function ($router, $controller) {
                ...
                $router->gridxRoutes('registry-extension-bundles', function ($router, $controller) {
