...
return [
    ...
    'console' => [
        'path' => env('CONSOLE_PATH', '/gridx/console'),
        'host' => env('CONSOLE_HOST', 'gridx.io'),
    ...
    'branding' => [
        'logo_url' => 'https://flb-assets.s3.ap-southeast-1.amazonaws.com/static/gridx-logo.png',
        'icon_url' => 'https://flb-assets.s3.ap-southeast-1.amazonaws.com/static/gridx-icon.png'
    ],
    'version' => env('GRIDX_VERSION', '0.7.1'),
    'instance_id' => env('GRIDX_INSTANCE_ID') ?? (file_exists(base_path('.gridx-id')) ? trim(file_get_contents(base_path('.gridx-id'))) : null),
