...
class UserCacheService
{
    ...
    {
        return (int) config('gridx.user_cache.browser_ttl', self::BROWSER_CACHE_TTL);
    }
    ...
    {
        return (int) config('gridx.user_cache.server_ttl', self::CACHE_TTL);
    }
    ...
    {
        return (bool) config('gridx.user_cache.enabled', true);
    }
