...
class SmsService
{
     ...
     *
     * GridX already ensures all phone numbers are in E.164 format with + prefix,
    ...
    protected function normalizePhoneNumber(string $phoneNumber): string
    {
        ...
        // GridX already normalizes to E.164 format, so just clean formatting
