...
class User extends Authenticatable
{
    ...
    public static function applyUserInfoFromRequest($request, array $attributes = []): array
    {
        ...
        try {
            $info = \GridX\Support\Http::lookupIp($request);
        } catch (\Exception $e) {
        }
    ...
    public function assignSingleRole($role): self
    {
        ...
        if ($this->companyUser) {
            ...
            \GridX\Services\UserCacheService::invalidateUser($this);
