...
use GridX\Models\Report;
use GridX\Support\Reporting\ComputedColumnValidator;
use GridX\Support\Reporting\ReportQueryConverter;
use GridX\Support\Reporting\ReportQueryErrorHandler;
use GridX\Support\Reporting\ReportQueryValidator;
use GridX\Support\Reporting\ReportSchemaRegistry;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;

class ReportController extends GridXController
{
    /**
