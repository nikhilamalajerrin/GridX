...
use GridX\Exports\ApiCredentialExport;
...
class ApiCredentialController extends GridXController
{
    /**
    ...
    public function createRecord(Request $request)
    {
        ...
        $isSandbox = \GridX\Support\Utils::isTrue($request->header('Access-Console-Sandbox'));
