...
namespace GridX\Http\Controllers\Api\v1;

use GridX\Http\Controllers\Controller;
use GridX\Http\Requests\CreateChatChannelRequest;
use GridX\Http\Requests\UpdateChatChannelRequest;
use GridX\Http\Resources\ChatChannel as ChatChannelResource;
use GridX\Http\Resources\ChatMessage as ChatMessageResource;
use GridX\Http\Resources\ChatParticipant as ChatParticipantResource;
use GridX\Http\Resources\ChatReceipt as ChatReceiptResource;
use GridX\Http\Resources\DeletedResource;
use GridX\Http\Resources\User as UserResource;
use GridX\Models\ChatAttachment;
use GridX\Models\ChatChannel;
use GridX\Models\ChatMessage;
...
{
    /**
     * Creates a new GridX Chat Channel resource.
     *
    ...
    /**
     * Updates a GridX Chat Channel resource.
     *
     * @param string $id
     *
     * @return ChatChannelResource
    ...
    /**
     * Query for GridX Chat Channel resources.
     *
     * @return \GridX\Http\Resources\ChatChannelCollection
     */
    ...
    /**
     * Finds a single GridX Chat Channel resources.
     *
     * @return \GridX\Http\Resources\ChatChannelCollection
     */
    ...
    /**
     * Deletes a GridX Chat Channel resources.
     *
     * @return \GridX\Http\Resources\ChatChannelCollection
     */
