...
class Find
{
     ...
     * @param string|null $namespace Optional. The namespace to search within, defaults to GridX's HTTP resource namespace.
    ...
    public static function httpResourceForModel(Model $model, ?string $namespace = null, ?int $version = 1): ?string
    {
        ...
        $defaultResourceNS = $coreResourceNS = '\\GridX\\Http\\Resources\\';
        $packageName       = static::getModelPackage($model);
        if ($packageName) {
            $defaultResourceNS = '\\GridX\\' . $packageName . '\\Http\\Resources\\';
        }
        ...
        try {
            ...
            $resourceNamespace = $coreResourceNS . 'GridXResource';
        }
     ...
     * @param string|null $namespace Optional. The base namespace for locating the request classes, defaults to GridX's HTTP requests namespace.
    ...
    public static function httpRequestForModel(Model $model, ?string $namespace = null, ?int $version = 1): ?string
    {
        ...
        $defaultRequestNS = '\\GridX\\Http\\Requests\\';
        ...
        try {
            ...
            $requestNamespace = $defaultRequestNS . 'GridXRequest';
        }
