 ...
 *      - createCompanyDump(\GridX\Models\Company $company, ?string $fileName = null): string
...
class SqlDumper
{
     ...
     *
     * @param \GridX\Models\Company $company
    ...
    public static function createCompanyDump($company, ?string $fileName = null)
    {
        ...
        // Write header
        file_put_contents($fileName, "-- GridX SQL Dump for company {$uuid}\n-- Generated at " . now()->toDateTimeString() . "\n\n");
