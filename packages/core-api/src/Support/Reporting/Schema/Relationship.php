...
namespace GridX\Support\Reporting\Schema;
...
class Relationship
{
    ...
    public function __construct(string $name, string $table, string $type = 'left')
    {
        ...
        $this->foreignKey = 'uuid'; // Default to uuid for GridX
    }
    ...
    {
        // For GridX, most foreign keys follow the pattern {relationship}_uuid
        return $name . '_uuid';
    }
}
