...
class Handler extends ExceptionHandler
{
    ...
    private function shouldManuallyHandleException(\Throwable $exception): bool
    {
        ...
        $exceptions = ['TokenMismatchException', 'ThrottleRequestsException', 'AuthenticationException', 'NotFoundHttpException', 'GridXRequestValidationException', 'ModelNotFoundException'];
    ...
    private function manuallyHandleException(\Throwable $exception): ?\Illuminate\Http\JsonResponse
    {
        ...
        switch ($type) {
            ...
            case 'GridXRequestValidationException':
                /** @var GridXRequestValidationException $exception */
