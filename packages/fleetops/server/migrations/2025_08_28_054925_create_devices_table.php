...
return new class extends Migration {
    public function up(): void
    {
        ...
        if (Schema::hasColumn('devices', 'vehicle_uuid')) {
            ...
            $vehicleModel = 'GridX\\\\FleetOps\\\\Models\\\\Vehicle';
            ...
            if ($this->isMySql()) {
                ...
                $vehicleModelPg = 'GridX\\FleetOps\\Models\\Vehicle';
                DB::statement("
                    UPDATE devices
    ...
    public function down(): void
    {
        ...
        $vehicleModelSqlMy = 'GridX\\\\FleetOps\\\\Models\\\\Vehicle';
        $vehicleModelSqlPg = 'GridX\\FleetOps\\Models\\Vehicle';
