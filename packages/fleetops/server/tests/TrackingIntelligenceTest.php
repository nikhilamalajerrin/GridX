...
use GridX\FleetOps\Tracking\Support\FakeTrackingProvider;
use GridX\FleetOps\Tracking\TrackingContextBuilder;
use GridX\FleetOps\Tracking\TrackingOptions;
use GridX\FleetOps\Tracking\TrackingProviderManager;
use GridX\FleetOps\Tracking\TrackingProviderRegistry;
...
test('tracking route legs include cumulative stop eta values', function () {
    ...
    $service = app(GridX\FleetOps\Tracking\TrackingIntelligenceService::class);
