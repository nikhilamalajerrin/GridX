...
use GridX\FleetOps\Http\Controllers\Api\v1\CustomerController;
use GridX\FleetOps\Http\Middleware\AuthenticateCustomerToken;
use GridX\FleetOps\Http\Requests\CreateCustomerOrderRequest;
use GridX\FleetOps\Http\Requests\CreateCustomerRequest;
use GridX\FleetOps\Http\Requests\VerifyCreateCustomerRequest;
use GridX\FleetOps\Http\Resources\v1\Customer as CustomerResource;
use GridX\FleetOps\Models\Customer as CustomerModel;
use GridX\FleetOps\Support\CustomerAuth;
...
test('customer controller does not introduce client-portal field aliases', function () {
    // Public GridX APIs must accept canonical model field names only. No
...
test('Customer model extends Contact with a type=customer global scope', function () {
    expect(is_subclass_of(CustomerModel::class, GridX\FleetOps\Models\Contact::class))->toBeTrue();
