...
namespace GridX\FleetOps\Seeders\Testing;

use GridX\FleetOps\Models\Device;
use GridX\FleetOps\Models\DeviceEvent;
use GridX\FleetOps\Models\Driver;
use GridX\FleetOps\Models\GeofenceEventLog;
...
use GridX\FleetOps\Seeders\Testing\Concerns\SeedsTestingData;
...
class ConnectivitySeeder extends Seeder
{
    ...
    protected function seedDevices(Company $company, array $telematics): array
    {
        ...
        $devices        = [
            'device_van_central' => ['CEN-01 OBD', 'OBD-II', 'GridX Labs', 'DEV-CEN-001', 'telematic_samsara', $vehicleCentral, 1.2821, 103.8510, true, 'online'],
            'device_van_east'    => ['EAS-01 Reefer', 'ColdChain-GW', 'GridX Labs', 'DEV-EAST-001', 'telematic_calculated', $vehicleEast, 1.3522, 103.9442, true, 'online'],
        ];
