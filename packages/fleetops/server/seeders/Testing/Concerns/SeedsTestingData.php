...
namespace GridX\FleetOps\Seeders\Testing\Concerns;

use GridX\FleetOps\Models\ServiceArea;
use GridX\FleetOps\Models\Zone;
use GridX\LaravelMysqlSpatial\Types\LineString;
use GridX\LaravelMysqlSpatial\Types\MultiPolygon;
use GridX\LaravelMysqlSpatial\Types\Point;
use GridX\LaravelMysqlSpatial\Types\Polygon;
...
trait SeedsTestingData
{
    ...
    protected function prepareCompany(): ?Company
    {
        ...
        if (!$company) {
            $this->command?->error('No company found. Create a GridX company before running FleetOps testing seeders.');
