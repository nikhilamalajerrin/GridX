...
class Fleet extends Model
{
    ...
    {
        return $this->belongsTo(\GridX\Models\File::class, 'image_uuid', 'uuid');
    }
    ...
    {
        return data_get($this, 'photo.url', 'https://s3.ap-northeast-2.amazonaws.com/gridx/public/default-fleet.png');
    }
