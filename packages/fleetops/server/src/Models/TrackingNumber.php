...
class TrackingNumber extends Model
{
    ...
    /**
     * Generates a gridx tracking number.
     *
     * @var string
     */
    public static function generateTrackingNumber($region = 'SG', $length = 10): string
    {
        $company     = \GridX\Models\Company::where('uuid', session('company'))->withoutGlobalScopes()->first();
    ...
    /**
     * Generates a unique gridx tracking number.
     *
     * @var string
     */
