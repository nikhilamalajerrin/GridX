...
class Payload extends Model
{
    ...
    public function setEntities($entities = [])
    {
        ...
        foreach ($entities as $attributes) {
            ...
            if (isset($attributes['photo'])) {
                ...
                $file = app(\GridX\Services\FileResolverService::class)->resolve($attributes['photo'], $path);
     ...
     *
     * @return \GridX\Models\Place|null
     */
     ...
     *
     * @param Point                               $location
     * @param \GridX\Models\Proof|string|null $proof    resolvable proof of delivery/activity
     *
     * @return $this
     */
