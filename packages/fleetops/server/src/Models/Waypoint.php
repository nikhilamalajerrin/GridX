...
use GridX\FleetOps\Traits\PayloadAccessors;
...
class Waypoint extends Model
{
     ...
     *
     * @param \GridX\Models\Place|string                    $place   the place instance or identifier (UUID or public_id)
     * @param \GridX\Models\Order|\GridX\Models\Payload $order   the order or payload model to scope the search
