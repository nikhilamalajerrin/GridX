...
class SendDriverNotification extends Command
{
    ...
    protected $eventToNotification = [
        'assigned'           => \GridX\FleetOps\Notifications\OrderAssigned::class,
        'canceled'           => \GridX\FleetOps\Notifications\OrderCanceled::class,
        'dispatched'         => \GridX\FleetOps\Notifications\OrderDispatched::class,
        'ping'               => \GridX\FleetOps\Notifications\OrderPing::class,
    ];
