...
use GridX\FleetOps\Events\EntityActivityChanged;
use GridX\FleetOps\Events\EntityCompleted;
use GridX\FleetOps\Events\OrderDispatchFailed;
use GridX\FleetOps\Events\OrderStarted;
use GridX\FleetOps\Events\WaypointActivityChanged;
use GridX\FleetOps\Events\WaypointCompleted;
use GridX\FleetOps\Exports\OrderExport;
use GridX\FleetOps\Flow\Activity;
use GridX\FleetOps\Http\Controllers\FleetOpsController;
use GridX\FleetOps\Http\Requests\BulkDispatchRequest;
use GridX\FleetOps\Http\Requests\CancelOrderRequest;
use GridX\FleetOps\Http\Requests\Internal\CreateOrderRequest;
use GridX\FleetOps\Http\Resources\v1\Index\Order as OrderIndexResource;
use GridX\FleetOps\Http\Resources\v1\Order as OrderResource;
use GridX\FleetOps\Http\Resources\v1\Proof as ProofResource;
use GridX\FleetOps\Imports\OrdersImport;
use GridX\FleetOps\Jobs\FinalizeInternalOrderCreation;
use GridX\FleetOps\Jobs\NotifyBulkAssignedDriver;
...
use GridX\FleetOps\Models\Proof;
use GridX\FleetOps\Models\ServiceQuote;
use GridX\FleetOps\Models\TrackingStatus;
use GridX\FleetOps\Models\Waypoint;
use GridX\FleetOps\Notifications\OrderPing;
use GridX\FleetOps\Support\ResolvesOrderServiceStops;
use GridX\FleetOps\Support\Utils;
use GridX\Http\Requests\ExportRequest;
use GridX\Http\Requests\Internal\BulkActionRequest;
use GridX\Models\File;
use GridX\Models\Type;
use GridX\Support\Auth;
use GridX\Support\TemplateString;
...
class OrderController extends FleetOpsController
{
            ...
            $record = $this->model->createRecordFromRequest(
                ...
                function ($request, &$input) {
                    ...
                    if ($serviceQuote instanceof ServiceQuote && $serviceQuote->fromIntegratedVendor()) {
                        // create order with integrated vendor, then resume gridx order creation
                        try {
                    ...
                    if (!$resolvedOrderConfig && $hasExplicitOrderConfig) {
                        throw new GridXRequestValidationException(['order_config_uuid' => 'The selected order config is invalid.']);
                    }
     ...
     * Updates a order to canceled and updates order activity.
     *
     * @param \GridX\Http\Requests\CancelOrderRequest $request
     *
     * @return \Illuminate\Http\Response
     */
    ...
    public function updateActivity(string $id, Request $request)
    {
        ...
        /**
         * @var \GridX\LaravelMysqlSpatial\Types\Point
         */
     ...
     *
     * @return \GridX\Http\Resources\v1\Order
     */
