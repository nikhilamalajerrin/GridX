...
use GridX\FleetOps\Http\Resources\v1\Orchestrator\Order as OrchestratorOrderResource;
use GridX\FleetOps\Models\Contact;
use GridX\FleetOps\Models\Driver;
use GridX\FleetOps\Models\Manifest;
use GridX\FleetOps\Models\ManifestStop;
...
use GridX\FleetOps\Orchestration\Engines\DriverAssignmentEngine;
use GridX\FleetOps\Orchestration\Engines\RouteSequencingEngine;
use GridX\FleetOps\Orchestration\OrchestrationEngineRegistry;
        ...
        $configs = OrderConfig::where('company_uuid', $companyUuid)
            ...
            ->map(function ($config) {
                ...
                if ($customFields->isEmpty()) {
                    $customFields = \GridX\Models\CustomField::where('subject_uuid', $config->uuid)
                        ->orderBy('order')
                        ->get();
                }
