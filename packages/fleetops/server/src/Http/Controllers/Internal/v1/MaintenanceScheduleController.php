...
use GridX\FleetOps\Imports\MaintenanceScheduleImport;
use GridX\FleetOps\Models\MaintenanceSchedule;
...
class MaintenanceScheduleController extends FleetOpsController
{
    ...
    public function ical(string $id): Response
    {
        ...
        $event = Event::create($eventTitle)
            ->uniqueIdentifier($schedule->uuid . '@gridx.io')
        ...
        $calendar = Calendar::create($eventTitle)
            ->productIdentifier('GridX FleetOps')
            ->event($event);
