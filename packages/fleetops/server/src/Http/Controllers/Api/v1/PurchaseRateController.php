...
use GridX\FleetOps\Http\Requests\CreatePurchaseRateRequest;
use GridX\FleetOps\Http\Resources\v1\PurchaseRate as PurchaseRateResource;
...
{
    /**
     * Creates a new GridX PurchaseRate resource.
     *
     * @param \GridX\Http\Requests\CreatePurchaseRateRequest $request
     *
     * @return \GridX\Http\Resources\PurchaseRate
     */
     ...
     *
     * @param \GridX\Models\ServiceQuote                     $serviceQuote
     * @param \GridX\Http\Requests\CreatePurchaseRateRequest $request
     *
     * @return \GridX\Models\Order|null
     */
    private function createOrderFromServiceQuote(?ServiceQuote $serviceQuote, CreatePurchaseRateRequest $request): ?Order
    {
        // if integrated vendor service quote create order with vendor first then create gridx order
    ...
    /**
     * Query for GridX PurchaseRate resources.
     *
     * @return \GridX\Http\Resources\PurchaseRateCollection
     */
    ...
    /**
     * Finds a single GridX PurchaseRate resources.
     *
     * @return \GridX\Http\Resources\PurchaseRateCollection
     */
