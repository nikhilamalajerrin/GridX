...
use GridX\FleetOps\Http\Requests\QueryServiceQuotesRequest;
...
use GridX\FleetOps\Models\ServiceQuoteItem;
...
{
    /**
     * Query for GridX ServiceQuote resources.
     *
     * @return \GridX\FleetOps\Http\Resources\ServiceQuoteCollection
     */
    ...
    /**
     * Query for GridX ServiceQuote from preliminary data resources.
     *
     * @param \GridX\Http\Requests\QueryServiceQuotesRequest $request
     *
     * @return \GridX\Http\Resources\ServiceQuoteCollection
     */
    public function queryFromPreliminary(QueryServiceQuotesRequest $request)
    {
        ...
        if ($facilitator && Utils::isIntegratedVendorId($facilitator)) {
            ...
            if ($integratedVendor) {
                try {
                    /** @var \GridX\Models\ServiceQuote $serviceQuote */
    ...
    /**
     * Finds a single GridX ServiceQuote resources.
     *
     * @return \GridX\Http\Resources\ServiceQuoteCollection
     */
