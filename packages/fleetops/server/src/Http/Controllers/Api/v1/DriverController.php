...
use GridX\FleetOps\Events\DriverLocationChanged;
use GridX\FleetOps\Events\GeofenceEntered;
use GridX\FleetOps\Events\GeofenceExited;
use GridX\FleetOps\Events\VehicleLocationChanged;
use GridX\FleetOps\Http\Requests\CreateDriverRequest;
use GridX\FleetOps\Http\Requests\DriverSimulationRequest;
use GridX\FleetOps\Http\Requests\UpdateDriverRequest;
use GridX\FleetOps\Http\Resources\v1\DeletedResource;
use GridX\FleetOps\Http\Resources\v1\Driver as DriverResource;
use GridX\FleetOps\Jobs\CheckGeofenceDwell;
use GridX\FleetOps\Jobs\SimulateDrivingRoute;
use GridX\FleetOps\Models\Driver;
use GridX\FleetOps\Models\Order;
use GridX\FleetOps\Models\Vehicle;
use GridX\FleetOps\Support\GeofenceIntersectionService;
use GridX\FleetOps\Support\OSRM;
use GridX\FleetOps\Support\Utils;
use GridX\Http\Controllers\Controller;
use GridX\Http\Requests\SwitchOrganizationRequest;
...
{
    /**
     * Creates a new GridX Driver resource.
     *
     * @return \GridX\Http\Resources\Driver
     */
    public function create(CreateDriverRequest $request)
    {
        ...
        if ($request->has('photo')) {
            ...
            $file = app(\GridX\Services\FileResolverService::class)->resolve($request->input('photo'), $path);
    ...
    /**
     * Updates a GridX Driver resource.
     *
     * @param string                                       $id
     * @param \GridX\Http\Requests\UpdateDriverRequest $request
     *
     * @return \GridX\Http\Resources\Driver
     */
    ...
    /**
     * Query for GridX Driver resources.
     *
     * @return \GridX\Http\Resources\DriverCollection
     */
    ...
    /**
     * Finds a single GridX Driver resources.
     *
     * @param string $id
     *
     * @return \GridX\Http\Resources\DriverCollection
    ...
    /**
     * Deletes a GridX Driver resources.
     *
     * @param string $id
     *
     * @return \GridX\Http\Resources\DriverCollection
     ...
     *          - Order.
     *
     * @param \GridX\Http\Requests\DriverSimulationRequest $request
     *
     * @return \Illuminate\Http\Response
     */
