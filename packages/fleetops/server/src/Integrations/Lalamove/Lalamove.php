...
namespace GridX\FleetOps\Integrations\Lalamove;

use GridX\FleetOps\Exceptions\IntegratedVendorException;
...
use GridX\FleetOps\Support\ParsePhone;
...
class Lalamove
{
    ...
    public function cancelFromGridXOrder(Order $order)
    {
