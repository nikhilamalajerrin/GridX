 ...
 *   2. Map     — map file columns to GridX order fields (grouped by section)
...
export default class OrchestratorImportComponent extends Component {
    ...
    @action downloadTemplate() {
        ...
        window.open('https://flb-assets.s3.ap-southeast-1.amazonaws.com/import-templates/GridX_Order_Import_Template.xlsx');
    }
}
