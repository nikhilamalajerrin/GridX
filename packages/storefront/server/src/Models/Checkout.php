...
class Checkout extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->belongsTo(Order::class);
    }
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->belongsTo(ServiceQuote::class);
    }
