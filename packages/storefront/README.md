<p align="center">
    <img src="https://flb-assets.s3.ap-southeast-1.amazonaws.com/static/storefront-logo.svg" alt="GridX Storefront" width="380">
</p>

<p align="center">
    Logistics-first headless commerce and marketplace infrastructure for GridX.
</p>

<p align="center">
    <a href="https://www.gridx.io/docs/storefront">Documentation</a>
    |
    <a href="https://github.com/gridx/storefront">GitHub</a>
    |
    <a href="https://www.gridx.io/platform/storefront">Platform Overview</a>
    |
    <a href="https://www.gridx.io">GridX</a>
</p>
...
<p align="center">
    <img src="https://www.gridx.io/images/screenshots/storefront/storefront-dashboard.webp" alt="GridX Storefront dashboard" width="860">
</p>

## Overview

Storefront is the commerce extension for GridX. It combines a Laravel API package with an Ember engine for the GridX Console, giving operators the tools to manage stores, products, carts, checkout, customers, marketplace networks, and fulfillment workflows from one logistics-native system.

Unlike a generic e-commerce plugin, Storefront is built around the handoff from purchase to delivery. A checkout can create Fleet-Ops orders, attach storefront order metadata, expose customer and commerce details in the GridX Console, and keep operators close to the real delivery lifecycle.

Read the official guide at [gridx.io/docs/storefront](https://www.gridx.io/docs/storefront).
...
| Area | Path | Purpose |
| --- | --- | --- |
| Ember engine | `addon/`, `app/`, `config/`, `translations/` | GridX Console UI, routes, models, components, services, widgets, and translations. |
...
The protected internal API is mounted under `storefront/int/v1`. It powers the GridX Console and includes:
...
Storefront is designed to run inside a GridX installation with `gridx/core-api` and `gridx/fleetops-api` available.
...
```bash
composer require gridx/core-api
composer require gridx/fleetops-api
composer require gridx/storefront-api
```
...
For the full local GridX workflow, see the [GridX Development Setup guide](https://www.gridx.io/docs/platform/quickstart/development-setup). That guide covers cloning the main repository with submodules, mounting live package source, linking extensions, running the Console dev server, and reloading the API after backend changes.

### Use Local Storefront Source in GridX

When developing Storefront inside the GridX monorepo, run the package linker from the repository root so the local `packages/storefront` source replaces the published Storefront packages used by Console and API:
...
If the linker is not installed yet, install it once from the GridX repository root:
...
For frontend changes, run the GridX Console dev server as described in the development setup guide; linked Ember packages are watched and live-reloaded by the dev server.
...
For customer app configuration, see the [Storefront App configuration docs](https://www.gridx.io/docs/storefront/app/configuration).

## Documentation

- [Storefront documentation](https://www.gridx.io/docs/storefront)
- [Products and catalog](https://docs.gridx.io/guides/storefront/products/)
- [Orders and checkout](https://www.gridx.io/docs/storefront/orders/overview)
- [Checkout flow](https://www.gridx.io/docs/storefront/orders/checkout)
- [Store locations](https://www.gridx.io/docs/storefront/stores/store-locations)
- [Storefront App configuration](https://www.gridx.io/docs/storefront/app/configuration)

## Contributing

Storefront follows the same review expectations as the rest of GridX:
...
GridX Storefront is open-source software licensed under the [AGPL-3.0-or-later](LICENSE.md).
