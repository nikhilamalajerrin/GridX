...
export default class TemplateBuilderQueryFormComponent extends Component {
    ...
    get resourceTypes() {
        ...
        return [
            { value: 'GridX\\FleetOps\\Models\\Order', label: 'Order', icon: 'box' },
            { value: 'GridX\\FleetOps\\Models\\Driver', label: 'Driver', icon: 'id-card' },
            { value: 'GridX\\FleetOps\\Models\\Place', label: 'Place', icon: 'location-dot' },
            { value: 'GridX\\FleetOps\\Models\\Vendor', label: 'Vendor', icon: 'building' },
            { value: 'GridX\\FleetOps\\Models\\Contact', label: 'Contact', icon: 'address-book' },
            { value: 'GridX\\FleetOps\\Models\\Issue', label: 'Issue', icon: 'triangle-exclamation' },
            { value: 'GridX\\FleetOps\\Models\\Vehicle', label: 'Vehicle', icon: 'truck' },
            { value: 'GridX\\FleetOps\\Models\\FuelReport', label: 'Fuel Report', icon: 'gas-pump' },
            { value: 'GridX\\FleetOps\\Models\\PurchaseRate', label: 'Purchase Rate', icon: 'receipt' },
        ];
    }
