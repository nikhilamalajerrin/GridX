 ...
 * resource types (GridX model classes) so the template builder knows
 ...
 *           { label: 'Order',   value: 'GridX\\FleetOps\\Models\\Order',   icon: 'route' },
 *           { label: 'Driver',  value: 'GridX\\FleetOps\\Models\\Driver',  icon: 'id-card' },
 *           { label: 'Vehicle', value: 'GridX\\FleetOps\\Models\\Vehicle', icon: 'truck' },
 *       ]);
 *   }
