...
export const DOCS_BASE_URL = 'https://www.gridx.io/docs/';
const OFFICIAL_DOC_HOSTS = ['www.gridx.io', 'gridx.io', 'docs.gridx.io'];
...
export default class DocsPanelService extends Service {
    ...
    get canEmbed() {
        ...
        try {
            ...
            return OFFICIAL_DOC_HOSTS.includes(parsed.hostname) && (parsed.hostname === 'docs.gridx.io' || parsed.pathname.startsWith('/docs'));
        } catch {
            return false;
        }
    }
    ...
    get bodyWrapperClass() {
        if (this.isIframeThemeDark) {
            return 'gridx-docs-panel-body gridx-docs-panel-body-dark';
        }

        return 'gridx-docs-panel-body gridx-docs-panel-body-light';
    }
    ...
    normalizeUrl(url, options = {}) {
        ...
        if (url.startsWith('/docs')) {
            return this.withDocsEmbedParams(`https://www.gridx.io${url}`, theme);
        }
