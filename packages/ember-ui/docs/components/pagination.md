# GridXPagination Component

## Usage

To use the GridX Pagination component, you can import it into your Ember component and include it in your template as follows:

```hbs

<GridXPagination @currentPage={{this.currentPage}} @totalPages={{this.totalPages}} @onPageChange={{this.handlePageChange}} />

```

You can customize the GridX Pagination component by passing in different props:
