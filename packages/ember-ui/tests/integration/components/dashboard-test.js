...
module('Integration | Component | dashboard', function (hooks) {
    ...
    test('it renders', async function (assert) {
        ...
        assert.dom('.gridx-dashboard-grid').exists();
    ...
    test('it supports an opt-in sticky header class', async function (assert) {
        ...
        assert.dom('.gridx-dashboard-grid').hasClass('gridx-dashboard-grid--sticky');

        await render(hbs`<Dashboard />`);

        assert.dom('.gridx-dashboard-grid').doesNotHaveClass('gridx-dashboard-grid--sticky');
    });
});
