...
namespace GridX\RegistryBridge\Support;
...
class Bridge
{
     ...
     *
     * @param User   $user     the gridx user model containing the username and email
    ...
    /**
     * Logs in to the gridx registry and retrieves the authentication token.
     *
     * This method uses the npm-cli-login tool to authenticate with the gridx registry,
