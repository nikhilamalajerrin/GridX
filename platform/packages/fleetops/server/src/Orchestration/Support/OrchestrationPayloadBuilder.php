...
namespace GridX\FleetOps\Orchestration\Support;
...
class OrchestrationPayloadBuilder
{
    ...
    /**
     * Build normalized route tasks from GridX orders.
     *
     * GridX orders must remain atomic during allocation. A task contains
    ...
    /**
     * Build normalized capacity-only tasks from GridX orders.
     *
    ...
    /**
     * Return GridX's canonical ordered stops for an order:
