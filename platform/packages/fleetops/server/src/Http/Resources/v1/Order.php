...
use GridX\FleetOps\Models\Contact as ContactModel;
use GridX\FleetOps\Support\Utils;
use GridX\Http\Resources\Comment;
use GridX\Http\Resources\File;
...
class Order extends GridXResource
{
    ...
    protected function transformMorphResource($model)
    {
        ...
        $resourceClass = \GridX\Support\Find::httpResourceForModel($model);
