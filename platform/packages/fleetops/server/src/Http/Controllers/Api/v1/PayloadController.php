...
use GridX\FleetOps\Http\Requests\CreatePayloadRequest;
use GridX\FleetOps\Http\Requests\UpdatePayloadRequest;
use GridX\FleetOps\Http\Resources\v1\DeletedResource;
use GridX\FleetOps\Http\Resources\v1\Payload as PayloadResource;
...
{
    /**
     * Creates a new GridX Payload resource.
     *
     * @param \GridX\Http\Requests\CreatePayloadRequest $request
     *
     * @return \GridX\Http\Resources\Payload
     */
    ...
    /**
     * Updates a GridX Payload resource.
     *
     * @param string                                        $id
     * @param \GridX\Http\Requests\UpdatePayloadRequest $request
     *
     * @return \GridX\Http\Resources\Payload
     */
    ...
    /**
     * Query for GridX Payload resources.
     *
     * @return \GridX\Http\Resources\PayloadCollection
     */
    ...
    /**
     * Finds a single GridX Payload resources.
     *
     * @return \GridX\Http\Resources\Payload
     */
    ...
    /**
     * Deletes a GridX Payload resources.
     *
     * @return \GridX\Http\Resources\Payload
     */
