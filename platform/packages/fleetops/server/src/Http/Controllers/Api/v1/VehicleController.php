...
use GridX\FleetOps\Http\Requests\CreateVehicleRequest;
use GridX\FleetOps\Http\Requests\UpdateVehicleRequest;
use GridX\FleetOps\Http\Resources\v1\DeletedResource;
use GridX\FleetOps\Http\Resources\v1\Vehicle as VehicleResource;
...
{
    /**
     * Creates a new GridX Vehicle resource.
     *
     * @param \GridX\Http\Requests\CreateVehicleRequest $request
     *
     * @return \GridX\Http\Resources\Vehicle
     */
    ...
    /**
     * Updates a GridX Vehicle resource.
     *
     * @param string                                        $id
     * @param \GridX\Http\Requests\UpdateVehicleRequest $request
     *
     * @return \GridX\Http\Resources\Vehicle
     */
    ...
    /**
     * Query for GridX Vehicle resources.
     *
     * @return \GridX\Http\Resources\VehicleCollection
     */
    ...
    /**
     * Finds a single GridX Vehicle resources.
     *
     * @param string $id
     *
     * @return \GridX\Http\Resources\VehicleCollection
    ...
    /**
     * Deletes a GridX Vehicle resources.
     *
     * @param string $id
     *
     * @return \GridX\Http\Resources\VehicleCollection
