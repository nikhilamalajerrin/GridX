...
use GridX\FleetOps\Http\Requests\CreateEquipmentRequest;
use GridX\FleetOps\Http\Requests\UpdateEquipmentRequest;
use GridX\FleetOps\Http\Resources\v1\DeletedResource;
use GridX\FleetOps\Http\Resources\v1\Equipment as EquipmentResource;
