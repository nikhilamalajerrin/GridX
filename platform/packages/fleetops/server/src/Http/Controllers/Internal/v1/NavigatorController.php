...
{
    /**
     * Redirects to the GridX Navigator app using a deep link.
    ...
    public function linkApp(Request $request)
    {
        ...
        $appIdentifier = config('fleetops.navigator.app_identifier', 'io.gridx.navigator');
    ...
    /**
     * Returns the URL used to link the GridX Navigator app.
     *
