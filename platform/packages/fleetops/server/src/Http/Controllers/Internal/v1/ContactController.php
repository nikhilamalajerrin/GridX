...
use GridX\FleetOps\Exports\ContactExport;
use GridX\FleetOps\Http\Controllers\FleetOpsController;
use GridX\FleetOps\Http\Resources\v1\Vendor as VendorResource;
use GridX\FleetOps\Imports\ContactImport;
use GridX\FleetOps\Mail\CustomerCredentialsMail;
...
class ContactController extends FleetOpsController
{
    ...
    {
        return collect(Utils::getInstalledGridXExtensions())
            ->contains(fn ($package) => data_get($package, 'name') === 'gridx/customer-portal-api');
    }
