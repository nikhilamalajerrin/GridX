...
namespace GridX\FleetOps\Traits;
...
trait HasTrackingNumber
{
     ...
     *
     * @param array|Point                         $location the location of the update, can be either [lat, lng] or a \GridX\LaravelMysqlSpatial\Types\Point instance
     * @param \GridX\Models\Proof|string|null $proof    resolvable proof of delivery/activity
     *
     * @return \GridX\Models\TrackingStatus
     */
     ...
     *
     * @return \GridX\Models\Proof|null
     */
