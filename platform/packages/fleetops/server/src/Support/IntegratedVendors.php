...
use GridX\FleetOps\Integrations\Lalamove\LalamoveMarket;
use GridX\FleetOps\Integrations\Lalamove\LalamoveServiceType;
...
class ResolvedIntegratedVendor
{
    ...
    {
        return Utils::assetFromGridX('integrated-vendors/' . $code . '.png');
    }
