...
use GridX\FleetOps\Exports\DeviceExport;
use GridX\FleetOps\Exports\MaintenanceExport;
use GridX\FleetOps\Exports\MaintenanceScheduleExport;
use GridX\FleetOps\Exports\VehicleExport;
use GridX\FleetOps\Exports\WorkOrderExport;
...
test('resources with visible export actions have backend export routes', function () {
    ...
    foreach (['devices', 'sensors', 'telematics', 'maintenance-schedules', 'work-orders', 'maintenances', 'equipment', 'parts'] as $resource) {
        expect($routes)->toContain("\$router->gridxRoutes('{$resource}'");
    }
