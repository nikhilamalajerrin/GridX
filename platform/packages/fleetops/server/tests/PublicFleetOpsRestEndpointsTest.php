...
use GridX\FleetOps\Http\Controllers\Api\v1\DeviceController;
use GridX\FleetOps\Http\Controllers\Api\v1\EquipmentController;
use GridX\FleetOps\Http\Controllers\Api\v1\FuelTransactionController;
use GridX\FleetOps\Http\Controllers\Api\v1\PartController;
use GridX\FleetOps\Http\Controllers\Api\v1\SensorController;
use GridX\FleetOps\Http\Controllers\Api\v1\WorkOrderController;
use GridX\FleetOps\Http\Resources\v1\Device;
use GridX\FleetOps\Http\Resources\v1\Equipment;
use GridX\FleetOps\Http\Resources\v1\FuelTransaction;
use GridX\FleetOps\Http\Resources\v1\Part;
use GridX\FleetOps\Http\Resources\v1\Sensor;
use GridX\FleetOps\Http\Resources\v1\WorkOrder;
