...
use GridX\FleetOps\Contracts\TelematicProviderDescriptor;
use GridX\FleetOps\Models\Telematic;
use GridX\FleetOps\Support\Telematics\Providers\AfaqyProvider;
use GridX\FleetOps\Support\Telematics\Providers\FlespiProvider;
use GridX\FleetOps\Support\Telematics\Providers\GeotabProvider;
use GridX\FleetOps\Support\Telematics\Providers\SafeeProvider;
use GridX\FleetOps\Support\Telematics\Providers\SamsaraProvider;
...
test('device event mark processed action is routed and company scoped', function () {
    ...
    expect($routes)
        ->toContain("\$router->gridxRoutes('device-events', function")
...
test('device attachment morph types are normalized and legacy aliases are tolerated', function () {
    ...
    expect($serviceProvider)
        ...
        ->toContain("'GridX\\\\Models\\\\Vehicle'   => \\GridX\\FleetOps\\Models\\Vehicle::class")
        ->toContain("'\\\\GridX\\\\Models\\\\Vehicle' => \\GridX\\FleetOps\\Models\\Vehicle::class");
});
