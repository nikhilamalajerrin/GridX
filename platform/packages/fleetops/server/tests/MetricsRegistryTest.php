...
use GridX\FleetOps\Support\Metrics\AbstractMetric;
use GridX\FleetOps\Support\Metrics\OrdersInProgressMetric;
use GridX\FleetOps\Support\Metrics\Registry;
use GridX\FleetOps\Support\Metrics\TotalTimeTraveledMetric;
...
test('active revenue query excludes inactive financial and operational lifecycle records', function () {
    ...
    expect(GridX\FleetOps\Support\Metrics\ActiveRevenueQuery::ACTIVE_STATUSES)->toBe([Transaction::STATUS_SUCCESS]);
    expect(GridX\FleetOps\Support\Metrics\ActiveRevenueQuery::ACTIVE_STATUSES)->not->toContain('completed');
    expect(GridX\FleetOps\Support\Metrics\ActiveRevenueQuery::ACTIVE_STATUSES)->not->toContain('paid');
});

test('active revenue query treats invoice status as invalidation only', function () {
    $inactiveInvoiceStatuses = GridX\FleetOps\Support\Metrics\ActiveRevenueQuery::INACTIVE_INVOICE_STATUSES;
