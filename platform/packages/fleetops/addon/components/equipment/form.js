...
const TYPE_TO_MODEL = {
    ...
    'GridX\\FleetOps\\Models\\Vehicle': 'vehicle',
    'GridX\\FleetOps\\Models\\Driver': 'driver',
    'fleet-ops:equipment': 'equipment',
};

const TYPE_TO_OPTION_VALUE = {
    'GridX\\FleetOps\\Models\\Vehicle': 'fleet-ops:vehicle',
    'GridX\\FleetOps\\Models\\Driver': 'fleet-ops:driver',
};
...
export default class EquipmentFormComponent extends Component {
    ...
    /**
     * Handles photo upload using the GridX fetch service upload pattern.
     */
