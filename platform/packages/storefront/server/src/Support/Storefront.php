...
namespace GridX\Storefront\Support;
...
use GridX\Storefront\Models\NotificationChannel;
...
use GridX\Storefront\Notifications\StorefrontOrderCreated;
...
class Storefront
{
    ...
    public static function createStripeCustomerForContact(Contact &$customer)
    {
        $stripeCustomer = \Stripe\Customer::create([
            'description' => 'Customer created in GridX Storefront',
     ...
     *
     * @param \GridX\Storefront\Models\Order $order
     *
     * @return \GridX\Storefront\Models\OrderConfig|null
     */
     ...
     *
     * @return \GridX\Storefront\Models\OrderConfig
     */
     ...
     *
     * @param Store|\GridX\FleetOps\Models\Network|string|null $subject
     ...
     * @param Store|\GridX\FleetOps\Models\Network|string|null $subject
     *
     * @return Store|\GridX\FleetOps\Models\Network|null
     */
