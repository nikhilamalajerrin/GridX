...
class AddonCategoryController extends StorefrontController
{
     ...
     * @throws \GridX\Exceptions\GridXRequestValidationException custom validation exceptions with error details
     */
    public function createRecord(Request $request)
    {
        try {
            ...
            return response()->error($e->getMessage());
        } catch (\GridX\Exceptions\GridXRequestValidationException $e) {
