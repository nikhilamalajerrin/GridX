...
Route::prefix(config('storefront.api.routing.prefix', 'storefront'))->namespace('GridX\Storefront\Http\Controllers')->group(
    function ($router) {
        /*
        |--------------------------------------------------------------------------
            ...
            function ($router) {
                ...
                $router->group(
                    ...
                    function ($router) {
                        ...
                        $router->gridxRoutes('customers');
                        $router->gridxRoutes('stores');
                        $router->gridxRoutes('store-hours');
                        $router->gridxRoutes('store-locations');
                        $router->gridxRoutes(
                            'products',
                            function ($router, $controller) {
                        ...
                        $router->gridxRoutes('product-hours');
                        $router->gridxRoutes('product-variants');
                        $router->gridxRoutes('product-variant-options');
                        $router->gridxRoutes('product-addons');
                        $router->gridxRoutes('product-addon-categories');
                        $router->gridxRoutes('addon-categories');
                        $router->gridxRoutes('gateways');
                        $router->gridxRoutes('notification-channels');
                        $router->gridxRoutes('reviews');
                        $router->gridxRoutes('votes');
                        $router->gridxRoutes('food-trucks');
                        $router->gridxRoutes('catalogs');
                        $router->gridxRoutes('catalog-categories');
                        $router->gridxRoutes('catalog-hours');
                        $router->group(
                            [],
                            function ($router) {
                                $router->group(
