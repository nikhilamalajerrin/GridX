...
class Customer extends Contact
{
    ...
    {
        return $this->hasMany(Review::class, 'customer_uuid')->where('subject_type', 'GridX\Storefront\Models\Product');
    }
    ...
    {
        return $this->hasMany(Review::class, 'customer_uuid')->where('subject_type', 'GridX\Storefront\Models\Store');
    }
    ...
    {
        return $this->hasMany(\GridX\Models\File::class, 'uploader_uuid')->where('type', 'storefront_review_upload');
    }
