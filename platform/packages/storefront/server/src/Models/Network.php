...
class Network extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->belongsTo(File::class);
    }
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->belongsTo(OrderConfig::class);
    }
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->hasMany(File::class, 'subject_uuid');
    }
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->hasMany(Invite::class, 'subject_uuid');
    }
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->hasMany(Category::class, 'owner_uuid')->where(['for' => 'network_category']);
    }
