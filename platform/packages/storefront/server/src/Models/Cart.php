...
class Cart extends StorefrontModel
{
    ...
    {
        return $this->setConnection(config('gridx.connection.db'))->belongsTo(Contact::class, 'public_id');
    }
     ...
     *
     * @return \GridX\Models\Storefront\Cart
     */
     ...
     *
     * @param \GridX\Models\Storefront\Product $product
     * @param int                                  $quantity
     * @param array                                $variants
     * @param array                                $addons
     */
