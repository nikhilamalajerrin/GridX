...
namespace GridX\Storefront\Console\Commands;
...
class SendOrderNotification extends Command
{
    ...
    protected $eventToNotification = [
        'created'          => \GridX\Storefront\Notifications\StorefrontOrderCreated::class,
        'canceled'         => \GridX\Storefront\Notifications\StorefrontOrderCanceled::class,
        'completed'        => \GridX\Storefront\Notifications\StorefrontOrderCompleted::class,
        'driver_assigned'  => \GridX\Storefront\Notifications\StorefrontOrderDriverAssigned::class,
        'enroute'          => \GridX\Storefront\Notifications\StorefrontOrderEnroute::class,
        'preparing'        => \GridX\Storefront\Notifications\StorefrontOrderPreparing::class,
        'ready_for_pickup' => \GridX\Storefront\Notifications\StorefrontOrderReadyForPickup::class,
        'nearby'           => \GridX\Storefront\Notifications\StorefrontOrderNearby::class,
    ];
