...
namespace GridX\Pallet\Providers;

use GridX\FleetOps\Providers\FleetOpsServiceProvider;
use GridX\Providers\CoreServiceProvider;

if (!class_exists(CoreServiceProvider::class)) {
    throw new \Exception('Pallet cannot be loaded without `gridx/core-api` installed!');
}

if (!class_exists(FleetOpsServiceProvider::class)) {
    throw new \Exception('Pallet cannot be loaded without `gridx/fleetops-api` installed!');
}
