...
return [
     ...
     */
    'signer' => \GridX\Webhook\Signer\DefaultSigner::class,
     ...
     */
    'backoff_strategy' => \GridX\Webhook\BackoffStrategy\ExponentialBackoffStrategy::class,

    /*
     * This class is used to dispatch webhooks on to the queue.
     */
    'webhook_job' => \GridX\Webhook\CallWebhookJob::class,
