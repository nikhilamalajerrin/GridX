...
class EmailDomainExcluded implements Rule
{
    ...
    public function __construct()
    {
        ...
        $this->domains = array_flip(file(base_path('vendor/gridx/core-api/storage/disposable_emails.txt'), FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES));
    }
