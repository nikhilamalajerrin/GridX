 ...
 * to environment variables and configuration settings within the GridX application. This allows
...
class EnvironmentMapper
{
    ...
    protected static array $settings = [
        ...
        ['settingsKey' => 'services.ipinfo', 'configKey' => 'gridx.services.ipinfo'],
