...
class Setting extends EloquentModel
{
    ...
    public static function getBranding()
    {
        $brandingSettings = [
            'id'       => 1,
            'uuid'     => 1,
            'icon_url' => config('gridx.branding.icon_url'),
            'logo_url' => config('gridx.branding.logo_url'),
        ];
    ...
    public static function getBrandingLogoUrl()
    {
        ...
        return config('gridx.branding.logo_url');
    }
    ...
    public static function getBrandingIconUrl()
    {
        ...
        return config('gridx.branding.icon_url');
    }
