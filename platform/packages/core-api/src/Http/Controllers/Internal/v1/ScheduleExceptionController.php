...
use GridX\Services\Scheduling\ScheduleService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class ScheduleExceptionController extends GridXController
{
    /**
    ...
    public function approve(string $id): JsonResponse
    {
        ...
        return response()->json([
            'status'             => 'ok',
            'schedule_exception' => new \GridX\Http\Resources\ScheduleException($exception),
        ]);
    }
    ...
    public function forSubject(Request $request): JsonResponse
    {
        ...
        return response()->json([
            'schedule_exceptions' => \GridX\Http\Resources\ScheduleException::collection($exceptions),
        ]);
    }
}
