...
use GridX\Notifications\TestPushNotification;
use GridX\Services\SmsService;
...
class SettingController extends Controller
{
    ...
    {
        $metrics                        = [];
        $metrics['total_users']         = \GridX\Models\User::all()->count();
        $metrics['total_organizations'] = \GridX\Models\Company::all()->count();
        $metrics['total_transactions']  = \GridX\Models\Transaction::all()->count();
    ...
    public function testMailConfig(AdminRequest $request)
    {
        ...
        try {
            Mail::send(new \GridX\Mail\TestMail($user, $mailer));
    ...
    public function testSmsProviderConfig(AdminRequest $request)
    {
        ...
        $message  = $request->input('message', 'This is a GridX SMS test.');
    ...
    {
        $title         = $request->input('title', 'Hello World from GridX 🚀');
    ...
    public function testTwilioConfig(AdminRequest $request)
    {
        ...
        try {
            \GridX\Twilio\Support\Laravel\Facade::message($phone, 'This is a Twilio test from GridX');
    ...
    public function testSocketcluster(AdminRequest $request)
    {
        ...
        $socketClusterClient = new \GridX\Support\SocketCluster\SocketClusterService();
