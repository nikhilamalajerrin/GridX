...
use GridX\Events\UserCreatedNewCompany;
use GridX\Exceptions\InvalidVerificationCodeException;
use GridX\Http\Controllers\Controller;
use GridX\Http\Requests\AdminRequest;
use GridX\Http\Requests\ChangePasswordRequest;
use GridX\Http\Requests\Internal\ResetPasswordRequest;
use GridX\Http\Requests\Internal\UserForgotPasswordRequest;
use GridX\Http\Requests\JoinOrganizationRequest;
use GridX\Http\Requests\LoginRequest;
use GridX\Http\Requests\SignUpRequest;
use GridX\Http\Requests\SwitchOrganizationRequest;
use GridX\Http\Resources\Organization;
use GridX\Mail\UserCredentialsMail;
...
use GridX\Notifications\UserForgotPassword;
use GridX\Support\Auth;
use GridX\Support\TwoFactorAuth;
use GridX\Support\Utils;
use GridX\Twilio\Support\Laravel\Facade as Twilio;
...
class AuthController extends Controller
{
    ...
    public function sendVerificationSms(Request $request)
    {
        ...
        try {
            Twilio::message($queryPhone, 'Your GridX authentication code is ' . $verifyCode);
    ...
    public function authenticateSmsCode(Request $request)
    {
        ...
        $bypassCode = config('gridx.sms_auth_bypass_code');
     ...
     *
     * @param \GridX\Http\Requests\SigUpRequest $request
     *
     * @return \Illuminate\Http\Response
     */
