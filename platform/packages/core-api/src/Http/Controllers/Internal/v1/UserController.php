...
use GridX\Attributes\SkipAuthorizationCheck;
use GridX\Events\UserRemovedFromCompany;
use GridX\Exceptions\GridXRequestValidationException;
use GridX\Exports\UserExport;
use GridX\Http\Controllers\GridXController;
use GridX\Http\Requests\CreateUserRequest;
use GridX\Http\Requests\ExportRequest;
use GridX\Http\Requests\Internal\AcceptCompanyInvite;
use GridX\Http\Requests\Internal\InviteUserRequest;
use GridX\Http\Requests\Internal\ResendUserInvite;
use GridX\Http\Requests\Internal\UpdatePasswordRequest;
use GridX\Http\Requests\Internal\ValidatePasswordRequest;
use GridX\Http\Requests\UpdateUserRequest;
use GridX\Models\Company;
use GridX\Models\CompanyUser;
use GridX\Models\Invite;
use GridX\Models\Permission;
use GridX\Models\Policy;
use GridX\Models\Setting;
use GridX\Models\User;
use GridX\Notifications\UserAcceptedCompanyInvite;
use GridX\Notifications\UserInvited;
use GridX\Services\UserCacheService;
...
class UserController extends GridXController
{
    /**
    ...
    {
        $isSandbox = config('gridx.connection.db') === 'sandbox';

        if ($isSandbox) {
            config([
                'database.default'        => env('DB_CONNECTION', 'mysql'),
                'gridx.connection.db' => env('DB_CONNECTION', 'mysql'),
            ]);
        }
