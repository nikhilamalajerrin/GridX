...
namespace GridX\Http\Resources;

use GridX\Http\Resources\Json\GridXPaginatedResourceResponse;
use Illuminate\Http\Resources\Json\ResourceCollection;
use Illuminate\Support\Arr;

/**
 * GridXResourceCollection.
 *
 * Usage:
 *   return (new GridXResourceCollection($paginator, Order::class))
 ...
 */
class GridXResourceCollection extends ResourceCollection
{
    /**
    ...
    protected function preparePaginatedResponse($request)
    {
        ...
        return (new GridXPaginatedResourceResponse($this))->toResponse($request);
    }
}
