...
class UserInvited extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage())
            ->subject('You\'ve been invited to join ' . $this->company->name . ' on GridX!')
            ->greeting('Hello, ' . $notifiable->name . '!')
            ->line($this->sender->name . ' has invited you to join their organization on GridX. Click the button below to accept this invitation and enable access to ' . $this->company->name . ' on GridX.')
