...
namespace GridX\Services\Scheduling;

use Carbon\Carbon;
use GridX\Models\Schedule;
use GridX\Models\ScheduleException;
use GridX\Models\ScheduleItem;
use GridX\Models\ScheduleTemplate;
...
class ScheduleService
{
    ...
    public function createSchedule(array $data): Schedule
    {
        return DB::transaction(function () use ($data) {
            ...
            event(new \GridX\Events\ScheduleCreated($schedule));
    ...
    public function updateSchedule(Schedule $schedule, array $data): Schedule
    {
        return DB::transaction(function () use ($schedule, $data) {
            ...
            event(new \GridX\Events\ScheduleUpdated($schedule));
    ...
    public function deleteSchedule(Schedule $schedule): bool
    {
        return DB::transaction(function () use ($schedule) {
            ...
            event(new \GridX\Events\ScheduleDeleted($schedule));
    ...
    public function createScheduleItem(array $data): ScheduleItem
    {
        return DB::transaction(function () use ($data) {
            ...
            event(new \GridX\Events\ScheduleItemCreated($item));
    ...
    public function updateScheduleItem(ScheduleItem $item, array $data): ScheduleItem
    {
        return DB::transaction(function () use ($item, $data) {
            ...
            event(new \GridX\Events\ScheduleItemUpdated($item));
    ...
    public function deleteScheduleItem(ScheduleItem $item): bool
    {
        return DB::transaction(function () use ($item) {
            ...
            event(new \GridX\Events\ScheduleItemDeleted($item));
    ...
    public function assignScheduleItem(ScheduleItem $item, string $assigneeType, string $assigneeUuid): ScheduleItem
    {
        return DB::transaction(function () use ($item, $assigneeType, $assigneeUuid) {
            ...
            event(new \GridX\Events\ScheduleItemAssigned($item));
