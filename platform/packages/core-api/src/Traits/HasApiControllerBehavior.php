...
trait HasApiControllerBehavior
{
     ...
     *
     * @var \GridX\Http\Resources\GridXResource
     */
    public $resource;
     ...
     *
     * @var \GridX\Http\Resources\GridXResource|null
     */
     ...
     *
     * This can be set to a specific GridXRequest instance or remain null
     ...
     */
    public function setApiModel(?Model $model = null, string $namespace = '\\GridX')
    {
     ...
     *
     * @param \GridX\Models\Model $model
     *
     * @return \GridX\Http\Resources\GridXResource
     */
     ...
     *
     * @throws GridXRequestValidationException
     */
    public function validateRequest(Request $request): void
    {
        ...
        if ($requestClass) {
            ...
            if ($validator->fails()) {
                throw new GridXRequestValidationException($validator->errors());
            }
     ...
     *
     * @return bool true if an update request is set and is a GridXRequest instance
     */
     ...
     *
     * @return bool true if a create request is set and is a GridXRequest instance
     */
