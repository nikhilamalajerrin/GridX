...
use GridX\Http\Resources\GridXResourceCollection;
use GridX\Ledger\Http\Controllers\LedgerResourceController;
use GridX\Ledger\Http\Resources\v1\Transaction as TransactionResource;
use GridX\Ledger\Http\Resources\v1\Wallet as WalletResource;
...
class WalletController extends LedgerResourceController
{
     ...
     */
    public function getTransactions(string $id, Request $request): AnonymousResourceCollection|GridXResourceCollection
    {
        $wallet = $this->resolveWallet($id);
