...
class WalletService
{
    ...
    public function topUp(
        ...
        if ($gatewayResponse->isSuccessful() && $gatewayResponse->status === \GridX\Ledger\DTO\GatewayResponse::STATUS_SUCCEEDED) {
            // Find the persisted GatewayTransaction
            $gatewayTransaction = \GridX\Ledger\Models\GatewayTransaction::where(
     ...
     *
     * @return \Illuminate\Support\Collection<\GridX\Ledger\Models\Wallet>
     */
