 ...
 * 
 * This file is automatically generated by the GridX extension build system.
 * Any manual changes will be overwritten on the next build.
 * 
 * @generated
 * @copyright © ${year} GridX Pte Ltd. All rights reserved.
...
`;
    ...
    included(app) {
        ...
        console.log('\n' + '/'.repeat(70));
        console.log('[GridX] Extension Build System');
    ...
    async generateExtensionFiles() {
        ...
        if (fs.existsSync(extensionsDir)) {
            console.log('[GridX] Cleaning up old extensions directory...');
        ...
        if (extensions.length > 0) {
            console.log(`[GridX] Discovered ${extensions.length} extension(s)`);
            extensions.forEach((ext) => {
                console.log(`[GridX]   - ${ext.name} (v${ext.version})`);
            });
            console.log('');
            ...
            console.log('[GridX] No extensions found — generating empty extension loader to satisfy module dependencies.');
        }
    ...
    generateExtensionShims(extensions) {
        ...
        extensions.forEach((extension) => {
            ...
            console.log(`[GridX]   ✓ Generated app/extensions/${mountPath}.js`);
        });
    },
...
`;
        ...
        console.log(`[GridX]   ✓ Generated app/extensions/index.js`);
    },
    ...
    generateRouter(extensions) {
        ...
        console.log(`[GridX]   ✓ Generated app/router.js`);
    },
    ...
    generateExtensionsManifest(extensions) {
        ...
        console.log(`[GridX]   ✓ Generated public/extensions.json`);
    },
    ...
    watchExtensionFiles() {
        ...
        this.getExtensions().then((extensions) => {
            ...
            watcher.on('change', (filePath) => {
                console.log(`\n[GridX] Extension file changed: ${path.basename(filePath)}`);
                console.log('[GridX] Regenerating extension files...\n');
